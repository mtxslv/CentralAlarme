...
// DECLARAÇÃO DE FUNÇÕES RELÓGIO
void SPI_Master_Setup(); 
void SPI_Master_Transmit(int dado); 
void RTC_Config();
...
void assSensorZona(int x, int y){
	...
	if(flag_D_sensor == 0){
		...
		if(y == 1){
			if(x == 0){zona1.sensor0 = 1; sensor0.zonaa = 1;}
			if(x == 1){zona1.sensor1 = 1; sensor1.zonaa = 1;}
			if(x == 2){zona1.sensor2 = 1; sensor2.zonaa = 1;}
			if(x == 3){zona1.sensor3 = 1; sensor3.zonaa = 1;}
			if(x == 4){zona1.sensor4 = 1; sensor4.zonaa = 1;}
			if(x == 5){zona1.sensor5 = 1; sensor5.zonaa = 1;}
			if(x == 6){zona1.sensor6 = 1; sensor6.zonaa = 1;}
			if(x == 7){zona1.sensor7 = 1; sensor7.zonaa = 1;}
		}else if(y == 2){
			if(x == 0){zona1.sensor0 = 1; sensor0.zonaa = 2;}
			if(x == 1){zona1.sensor1 = 1; sensor1.zonaa = 2;}
			if(x == 2){zona1.sensor2 = 1; sensor2.zonaa = 2;}
			if(x == 3){zona1.sensor3 = 1; sensor3.zonaa = 2;}
			if(x == 4){zona1.sensor4 = 1; sensor4.zonaa = 2;}
			if(x == 5){zona1.sensor5 = 1; sensor5.zonaa = 2;}
			if(x == 6){zona1.sensor6 = 1; sensor6.zonaa = 2;}
			if(x == 7){zona1.sensor7 = 1; sensor7.zonaa = 2;}
		}else if(y == 3){
			if(x == 0){zona1.sensor0 = 1; sensor0.zonaa = 3;}
			if(x == 1){zona1.sensor1 = 1; sensor1.zonaa = 3;}
			if(x == 2){zona1.sensor2 = 1; sensor2.zonaa = 3;}
			if(x == 3){zona1.sensor3 = 1; sensor3.zonaa = 3;}
			if(x == 4){zona1.sensor4 = 1; sensor4.zonaa = 3;}
			if(x == 5){zona1.sensor5 = 1; sensor5.zonaa = 3;}
			if(x == 6){zona1.sensor6 = 1; sensor6.zonaa = 3;}
			if(x == 7){zona1.sensor7 = 1; sensor7.zonaa = 3;}
		}
	}else if(flag_D_sensor == 1){
...
// ATIVAR A SIRENE EM CASO DE SENSOR DETECTAR ALGO //

void activate_sirene(){
	
	if((sensor0.active == 1) & ((( varLeituraSerial >> 8 ) & 1 ) == 0)){
		if((sensor0.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
		}else if((sensor0.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
		}else if((sensor0.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor1.active == 1) & ((( varLeituraSerial >> 7 ) & 1 ) == 0)){
		if((sensor1.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
		}else if((sensor1.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
		}else if((sensor1.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor2.active == 1) & ((( varLeituraSerial >> 6 ) & 1 ) == 0)){
		if((sensor2.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
		}else if((sensor2.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
		}else if((sensor2.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor3.active == 1) & ((( varLeituraSerial >> 5 ) & 1 ) == 0)){
		if((sensor3.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
			}else if((sensor3.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
			}else if((sensor3.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor4.active == 1) & ((( varLeituraSerial >> 4 ) & 1 ) == 0)){
		if((sensor4.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
			}else if((sensor4.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
			}else if((sensor4.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor5.active == 1) & ((( varLeituraSerial >> 3 ) & 1 ) == 0)){
		if((sensor5.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
			}else if((sensor5.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
			}else if((sensor5.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor6.active == 1) & ((( varLeituraSerial >> 2 ) & 1 ) == 0)){
		if((sensor6.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
			}else if((sensor6.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
			}else if((sensor6.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
	else if((sensor7.active == 1) & ((( varLeituraSerial >> 1 ) & 1 ) == 0)){
		if((sensor7.zonaa == 1) & (zona1.active == 1)){
			StartSirene();
			}else if((sensor7.zonaa == 2) & (zona2.active == 1)){
			StartSirene();
			}else if((sensor7.zonaa == 3) & (zona3.active == 1)){
			StartSirene();
		}
	}
...
// NÃO PRECISA MUDAR DE ESTADO FORA DO TIMER - NO FINAL DA CONTAGEM, JÁ É FEITA A TRANSFERÊNCIA DE ESTADO, MAS ISSO PODE SER MUDADO SE DESEJADO
{
	...
	else if(state == verificar_senhaA)
	{
		if(cont_ativacao == t_ativacao)
		{
			...
			cont_ativacao = 0;
			varEscritaSerial |= 0x80;
			varEscritaSerial |= var_aux_1;
			StopTimer1();
		}
		else
		{
...
void RTC_Config(){
	int timeH = 0b00000001;
	int timeM = 0b00000000;
	int timeD = 0b00000001;
	PORTB &= ~(1 << (PINB2));
	SPI_Master_Transmit(0x82);
	while(!(SPSR & (1<<SPIF)));
	SPI_Master_Transmit(timeH);
	while(!(SPSR & (1<<SPIF)));
	PORTB |= (1<<PORTB2);
	PORTB &= ~(1 << (PINB2));
	SPI_Master_Transmit(0x81);
	while(!(SPSR & (1<<SPIF)));
	SPI_Master_Transmit(timeM);
	while(!(SPSR & (1<<SPIF)));
	PORTB |= (1<<PORTB2);
	PORTB &= ~(1 << (PINB2));
	SPI_Master_Transmit(0x83);
	while(!(SPSR & (1<<SPIF)));
	SPI_Master_Transmit(timeD);
	while(!(SPSR & (1<<SPIF)));
	PORTB |= (1<<PORTB2);
}
...
void IniciarUART (uint32_t taxa, uint32_t freqCpu){
	...
	UCSR0B = (1<<TXEN0); // hab trans  SEM interrupção
